...
public class ContributionService {
    ...
    public ContributionService(AccountRepository accountRepository, ContributionsRepository contributionsRepository, CurrencyConvertService currencyConvertService) {
